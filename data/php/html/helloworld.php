...
$frontendKey = TagKey::create("example_com_keys_frontend");

// $videoSize will measure the size of processed videos.
$videoSize = Measure::newIntMeasure("example_com_measure_video_size", "size of processed videos", Measure::BYTES);
